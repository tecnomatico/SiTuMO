...
class content extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('No_Laborales.Content.View');
	...
	{
		$this->auth->restrict('No_Laborales.Content.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_no_laborales())
			{
				...
				redirect(SITE_AREA .'/content/no_laborales');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('No_Laborales.Content.Edit');
		...
		{
			$this->auth->restrict('No_Laborales.Content.Delete');
