...
class developer extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('No_Laborales.Developer.View');
	...
	{
		$this->auth->restrict('No_Laborales.Developer.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_no_laborales())
			{
				...
				redirect(SITE_AREA .'/developer/no_laborales');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('No_Laborales.Developer.Edit');
		...
		{
			$this->auth->restrict('No_Laborales.Developer.Delete');
