...
class settings extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('No_Laborales.Settings.View');
	...
	{
		$this->auth->restrict('No_Laborales.Settings.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_no_laborales())
			{
				...
				redirect(SITE_AREA .'/settings/no_laborales');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('No_Laborales.Settings.Edit');
		...
		{
			$this->auth->restrict('No_Laborales.Settings.Delete');
