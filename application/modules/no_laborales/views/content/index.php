...
$num_columns	= 5;
$can_delete	= $this->auth->has_permission('No_Laborales.Content.Delete');
$can_edit		= $this->auth->has_permission('No_Laborales.Content.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/content/no_laborales/edit/' . $record->nid, '<span class="icon-pencil"></span>' .  $record->mid); ?></td>
				<?php else : ?>
