	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
			...
			<div class="form-actions">
				<input type="submit" name="save" class="btn btn-primary" value="<?php echo lang('no_laborales_action_edit'); ?>"  />
				<?php echo lang('bf_or'); ?>
				<?php echo anchor(SITE_AREA .'/developer/no_laborales', lang('no_laborales_cancel'), 'class="btn btn-warning"'); ?>
				
			<?php if ($this->auth->has_permission('No_Laborales.Developer.Delete')) : ?>
				or
				<button type="submit" name="delete" class="btn btn-danger" id="delete-me" onclick="return confirm('<?php e(js_escape(lang('no_laborales_delete_confirm'))); ?>'); ">
					<span class="icon-trash icon-white"></span>&nbsp;<?php echo lang('no_laborales_delete_record'); ?>
				</button>
			<?php endif; ?>
			</div>
		</fieldset>
