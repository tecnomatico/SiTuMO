	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
			...
			<div class="form-actions">
				...
				<?php echo lang('bf_or'); ?>
				<?php echo anchor(SITE_AREA .'/reports/no_laborales', lang('no_laborales_cancel'), 'class="btn btn-warning"'); ?>
				
			<?php if ($this->auth->has_permission('No_Laborales.Reports.Delete')) : ?>
				or
