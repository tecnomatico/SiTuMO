...
$num_columns	= 5;
$can_delete	= $this->auth->has_permission('No_Laborales.Reports.Delete');
$can_edit		= $this->auth->has_permission('No_Laborales.Reports.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/reports/no_laborales/edit/' . $record->nid, '<span class="icon-pencil"></span>' .  $record->mid); ?></td>
				<?php else : ?>
