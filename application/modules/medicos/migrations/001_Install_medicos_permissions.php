...
class Migration_Install_medicos_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Medicos.Gestion.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Medicos.Gestion.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Medicos.Gestion.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Medicos.Gestion.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
