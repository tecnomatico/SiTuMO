...
class reports extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Turnos.Reports.View');
	...
	{
		$this->auth->restrict('Turnos.Reports.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_turnos())
			{
				...
				redirect(SITE_AREA .'/reports/turnos');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Turnos.Reports.Edit');
		...
		{
			$this->auth->restrict('Turnos.Reports.Delete');
