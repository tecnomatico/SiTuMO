...
class developer extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Turnos.Developer.View');
	...
	{
		$this->auth->restrict('Turnos.Developer.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_turnos())
			{
				...
				redirect(SITE_AREA .'/developer/turnos');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Turnos.Developer.Edit');
		...
		{
			$this->auth->restrict('Turnos.Developer.Delete');
