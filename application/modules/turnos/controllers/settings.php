...
class settings extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Turnos.Settings.View');
	...
	{
		$this->auth->restrict('Turnos.Settings.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_turnos())
			{
				...
				redirect(SITE_AREA .'/settings/turnos');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Turnos.Settings.Edit');
		...
		{
			$this->auth->restrict('Turnos.Settings.Delete');
