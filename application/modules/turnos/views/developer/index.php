...
$num_columns	= 4;
$can_delete	= $this->auth->has_permission('Turnos.Developer.Delete');
$can_edit		= $this->auth->has_permission('Turnos.Developer.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/developer/turnos/edit/' . $record->tid, '<span class="icon-pencil"></span>' .  $record->mid); ?></td>
				<?php else : ?>
