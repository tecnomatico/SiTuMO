...
class Migration_Install_clinicas_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Clinicas.Gestion.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Clinicas.Gestion.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Clinicas.Gestion.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Clinicas.Gestion.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
