...
class reports extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Franjas.Reports.View');
	...
	{
		$this->auth->restrict('Franjas.Reports.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_franjas())
			{
				...
				redirect(SITE_AREA .'/reports/franjas');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Franjas.Reports.Edit');
		...
		{
			$this->auth->restrict('Franjas.Reports.Delete');
