...
class content extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Franjas.Content.View');
	...
	{
		$this->auth->restrict('Franjas.Content.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_franjas())
			{
				...
				redirect(SITE_AREA .'/content/franjas');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Franjas.Content.Edit');
		...
		{
			$this->auth->restrict('Franjas.Content.Delete');
