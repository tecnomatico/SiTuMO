...
class settings extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Franjas.Settings.View');
	...
	{
		$this->auth->restrict('Franjas.Settings.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_franjas())
			{
				...
				redirect(SITE_AREA .'/settings/franjas');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Franjas.Settings.Edit');
		...
		{
			$this->auth->restrict('Franjas.Settings.Delete');
