...
$num_columns	= 10;
$can_delete	= $this->auth->has_permission('Franjas.Developer.Delete');
$can_edit		= $this->auth->has_permission('Franjas.Developer.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/developer/franjas/edit/' . $record->fid, '<span class="icon-pencil"></span>' .  $record->mid); ?></td>
				<?php else : ?>
